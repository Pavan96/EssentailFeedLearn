...
//
//  Created by Pavan More on 22/07/22.
//
...
class EssentailFeedAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedResult(file: StaticString = #file, line: UInt = #line) -> LoadFeedResult? {
        ...
        let loader = RemoetFeedLoader(client: client, url: testServerURL)
    ...
    private func expectedItem(at index: Int) -> FeedItem {
        return FeedItem(id: id(at: index), location: location(at: index), description: description(at: index), imageURL: imageURL(at: index))
    }
